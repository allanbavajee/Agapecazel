  ...
  return (
    <>
      ...
      <div style={s.root}>
        ...
        <section id="a-propos" style={s.section}>
          <div style={{ ...s.inner, display: "grid", gridTemplateColumns: "1fr 340px", gap: 72, alignItems: "center" }}>
            <div>
              ...
              <h2 style={s.secTitle}>
                Centre d'appel spécialisé<br />en génération de rendez-vous qualifiés
              </h2>
              <p style={{ color: "#8896B0", lineHeight: 1.8, marginBottom: 28, fontSize: 15 }}>
                ...
                ciblée et une génération de rendez-vous hautement qualifiés. Basé à l'île Maurice, notre centre
                d'appel est spécialisé dans :
              </p>
              <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 14, marginBottom: 36 }}>
                {[
                  ...
                  <li
                    key={item}
                    style={{ display: "flex", gap: 12, alignItems: "flex-start", color: "#8896B0", fontSize: 14, lineHeight: 1.6 }}
                  >
            ...
            <div>
              {[
                ...
                <div key={card.label} style={s.whyCard}>
                  ...
                  <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 44, fontWeight: 700, color: "#F0E6D0", lineHeight: 1 }}>
                    {card.value}
                  </p>
        ...
        <section
          id="contact"
          style={{ ...s.section, background: "#0A1628", borderTop: "1px solid rgba(200,169,110,0.1)" }}
        >
          <div style={{ ...s.inner, maxWidth: 640 }}>
            <p style={{ ...s.eyebrow, textAlign: "center" }}>Prêt à démarrer ?</p>
            <h2 style={{ ...s.secTitle, textAlign: "center" }}>
            ...
            {formState === "success" ? (
              <div style={s.successBox}>
                ...
                <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 24, color: "#F0E6D0" }}>
                  Message envoyé !
                </p>
                <p style={{ color: "#8896B0", fontSize: 14 }}>Notre équipe vous contacte sous 24h.</p>
                <button
                  onClick={() => setFormState("idle")}
                  style={{ ...s.btnPrimary, marginTop: 8, border: "none", cursor: "pointer" }}
                >
        ...
        <footer style={s.footer}>
          <div style={s.footerInner}>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <a
                href="https://www.linkedin.com/in/agapecazel-call-center-a103773bb?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/share/18PgV2ZUAC/"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#C8A96E", fontSize: 12, border: "1px solid rgba(200,169,110,.18)", padding: "5px 14px", borderRadius: 2 }}
              >
...
const s = {
  ...
  countriesGrid:{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14 },
